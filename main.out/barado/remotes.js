...
return (function (p__27026){
var vec__27027 = p__27026;
var param = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27027,(0),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27027,(1),null);
...
var G__27030 = xhr_url;
var G__27031 = ((function (G__27030,params,str_params,xhr_url){
return (function (e){
var xhr = e.target;
...
});})(G__27030,params,str_params,xhr_url))
;
return goog.net.XhrIo.send(G__27030,G__27031);
});
barado.remotes.process_lines = (function barado$remotes$process_lines(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__27045){
var vec__27046 = p__27045;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27046,(0),null);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27046,(1),null);
return new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$line_SLASH_id,id,cljs.core.cst$kw$line_SLASH_label,cljs.core.get.cljs$core$IFn$_invoke$arity$2(line,"line-name"),cljs.core.cst$kw$line_SLASH_stations,cljs.core.vec(cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(((function (vec__27046,id,line){
return (function (s){
...
,cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(((function (vec__27046,id,line){
return (function (i,p__27049){
var vec__27050 = p__27049;
var station_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27050,(0),null);
var station_platforms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27050,(1),null);
return new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$station_SLASH_id,i,cljs.core.cst$kw$station_SLASH_label,station_name,cljs.core.cst$kw$station_SLASH_platforms,cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(((function (vec__27050,station_name,station_platforms,vec__27046,id,line){
return (function (p__27053){
var vec__27054 = p__27053;
var id__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27054,(0),null);
var platform = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27054,(1),null);
...
});})(vec__27050,station_name,station_platforms,vec__27046,id,line))
,station_platforms)], null);
});})(vec__27046,id,line))
,cljs.core.group_by(((function (vec__27046,id,line){
return (function (p1__27032_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.second(p1__27032_SHARP_),"station-name");
});})(vec__27046,id,line))
 ...
 */
barado.remotes.send = (function barado$remotes$send(get_rec,p__27057,cb){
var map__27062 = p__27057;
...
var remotes = map__27062__$1;
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27062__$1,cljs.core.cst$kw$lines);
var line_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27062__$1,cljs.core.cst$kw$line_DASH_data);
if(cljs.core.truth_(lines)){
barado.remotes.GET([cljs.core.str(barado.remotes.api_uri),cljs.core.str("line")].join(''),new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$params,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$format,"transit"], null),cljs.core.cst$kw$response_DASH_format,cljs.core.cst$kw$transit,cljs.core.cst$kw$handler,((function (map__27062,map__27062__$1,remotes,lines,line_data){
return (function (d){
...
var G__27064_27066 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$system_SLASH_lines,system_lines], null);
var G__27065_27067 = lines;
(cb.cljs$core$IFn$_invoke$arity$2 ? cb.cljs$core$IFn$_invoke$arity$2(G__27064_27066,G__27065_27067) : cb.call(null,G__27064_27066,G__27065_27067));

return om.next.update_query_BANG_.cljs$core$IFn$_invoke$arity$2(om.next.app_root(reconciler),((function (reconciler,system_lines,default_line,default_station,default_platform,map__27062,map__27062__$1,remotes,lines,line_data){
return (function (q){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(q,cljs.core.cst$kw$params,((function (reconciler,system_lines,default_line,default_station,default_platform,map__27062,map__27062__$1,remotes,lines,line_data){
return (function (p){
...
});})(reconciler,system_lines,default_line,default_station,default_platform,map__27062,map__27062__$1,remotes,lines,line_data))
);
});})(reconciler,system_lines,default_line,default_station,default_platform,map__27062,map__27062__$1,remotes,lines,line_data))
);
});})(map__27062,map__27062__$1,remotes,lines,line_data))
], null));
} else {
}
...
return barado.remotes.GET([cljs.core.str(barado.remotes.api_uri),cljs.core.str("predict")].join(''),new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$params,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$line,line_id,cljs.core.cst$kw$format,"transit"], null),cljs.core.cst$kw$response_DASH_format,cljs.core.cst$kw$transit,cljs.core.cst$kw$handler,((function (line_id,map__27062,map__27062__$1,remotes,lines,line_data){
return (function (d){
return (cb.cljs$core$IFn$_invoke$arity$2 ? cb.cljs$core$IFn$_invoke$arity$2(d,line_data) : cb.call(null,d,line_data));
});})(line_id,map__27062,map__27062__$1,remotes,lines,line_data))
], null));
} else {
return null;
}
...
barado.remotes.incorp = (function (){var method_table__8549__auto__ = (function (){var G__27068 = cljs.core.PersistentArrayMap.EMPTY;
...
var prefer_table__8550__auto__ = (function (){var G__27069 = cljs.core.PersistentArrayMap.EMPTY;
return (cljs.core.atom.cljs$core$IFn$_invoke$arity$1 ? cljs.core.atom.cljs$core$IFn$_invoke$arity$1(G__27069) : cljs.core.atom.call(null,G__27069));
})();
var method_cache__8551__auto__ = (function (){var G__27070 = cljs.core.PersistentArrayMap.EMPTY;
return (cljs.core.atom.cljs$core$IFn$_invoke$arity$1 ? cljs.core.atom.cljs$core$IFn$_invoke$arity$1(G__27070) : cljs.core.atom.call(null,G__27070));
})();
var cached_hierarchy__8552__auto__ = (function (){var G__27071 = cljs.core.PersistentArrayMap.EMPTY;
return (cljs.core.atom.cljs$core$IFn$_invoke$arity$1 ? cljs.core.atom.cljs$core$IFn$_invoke$arity$1(G__27071) : cljs.core.atom.call(null,G__27071));
})();
...
return (function (new_st,p__27072){
var vec__27073 = p__27072;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27073,(0),null);
var datum = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27073,(1),null);
var buckets = cljs.core.get.cljs$core$IFn$_invoke$arity$2(datum,"buckets");
return cljs.core.assoc_in(new_st,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$platform_SLASH_by_DASH_id,id,cljs.core.cst$kw$platform_SLASH_data], null),cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.sorted_map(),cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(((function (buckets,vec__27073,id,datum,created){
return (function (p__27076){
var vec__27077 = p__27076;
var minute = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27077,(0),null);
var bucket = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27077,(1),null);
...
});})(buckets,vec__27073,id,datum,created))
,buckets)));
});})(created))
